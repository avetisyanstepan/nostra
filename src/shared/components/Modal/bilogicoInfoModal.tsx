...
export const BiologicoInfoModal:React.FC<any> = ({product, close}) => {
        ...
        <StyledBox>
          ...
          <StyledGridContainer>
            <StyledInfoBox mr={'40'} border flex>
              ...
              <StyledTitle 
                active={'riboflavina' === activeName}
                onClick={() => setActiveName('riboflavina')}
              >
                {activeName === 'riboflavina' && <StyledUnionbox> <UnionIcon /></StyledUnionbox>  }
                Riboflavina   (mg)
              </StyledTitle>
              <StyledTitle 
                active={'calci' === activeName} 
                onClick={() => setActiveName('calci')}
              >
                {activeName === 'calci' && <StyledUnionbox> <UnionIcon /></StyledUnionbox>  }
                Cálcio   (mg)
              </StyledTitle>
              <StyledTitle 
                active={'fosforo' === activeName} 
                onClick={() => setActiveName('fosforo')}
              >
                {activeName === 'fosforo' && <StyledUnionbox> <UnionIcon /></StyledUnionbox>  }
                Fósforo   (mg)
              </StyledTitle>
              <StyledTitle 
                active={'iodo' === activeName}
                onClick={() => setActiveName('iodo')}
              >
                {activeName === 'iodo' && <StyledUnionbox> <UnionIcon /></StyledUnionbox>  }
                Iodo   (μg)
              </StyledTitle>
            </StyledInfoBox>
            <StyledInfoBox bg={'green'} mr={'14'} ml center>
              <StyledDivRow abs>
               ...
               <StyledTitle active={'lipidos' === activeName}>3.6</StyledTitle>
               <StyledTitle active={'saturados' === activeName}>2.6</StyledTitle>
               <StyledTitle active={'carbono' === activeName } >5</StyledTitle>
               <StyledTitle active={'acucares' === activeName} >4.7</StyledTitle>
               <StyledTitle active={'protein' === activeName}>3.2</StyledTitle>
               <StyledTitle active={'sal' === activeName}>0.1</StyledTitle>
               <StyledTitle active={'riboflavina' === activeName}>0,13 ( 9% VRN)</StyledTitle>
               <StyledTitle active={'calci' === activeName}>115 ( 14% VRN )</StyledTitle>
               <StyledTitle active={'fosforo' === activeName}>91 ( 13% VRN )</StyledTitle>
               <StyledTitle active={'iodo' === activeName}>21 ( 14% VRN )</StyledTitle>
            </StyledInfoBox>
            <StyledInfoBox bg={'green'} center>
              <StyledDivRow abs>
                <StyledSpanPor>por 250ml</StyledSpanPor>
              </StyledDivRow>
               <StyledTitle>682 kJ / 163 kcal</StyledTitle>
               <StyledTitle active={'lipidos' === activeName}>9</StyledTitle>
               <StyledTitle active={'saturados' === activeName}>6.5</StyledTitle>
               <StyledTitle active={'carbono' === activeName }>12.5</StyledTitle>
               <StyledTitle active={'acucares' === activeName}>11.8</StyledTitle>
               <StyledTitle active={'protein' === activeName}>8</StyledTitle>
               <StyledTitle active={'sal' === activeName}>0.25</StyledTitle>
               <StyledTitle active={'riboflavina' === activeName}>0,33 ( 24% VRN)</StyledTitle>
               <StyledTitle active={'calci' === activeName}>288 ( 36% VRN )</StyledTitle>
               <StyledTitle active={'fosforo' === activeName}>228 ( 33% VRN )</StyledTitle>
               <StyledTitle active={'iodo' === activeName}>53 ( 25% VRN )</StyledTitle>
            </StyledInfoBox>
...
const StyledInfoBox = styled.div<any>`
  ...
  max-width: ${props => props.flex ? '250px' : '205px'};
  width: 100%;
