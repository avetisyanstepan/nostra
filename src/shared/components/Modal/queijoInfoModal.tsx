...
export const QueijoInfoModal:React.FC<any> = ({product, close}) => {
    ...
    return (
          ...
          <StyledGridContainer>
            ...
            <StyledInfoBox bg={'green'} mr={'14'} ml center>
              <StyledDivRow abs>
               ...
               <StyledTitle active={'lipidos' === activeName}>26</StyledTitle>
               <StyledTitle active={'saturados' === activeName}>17.5</StyledTitle>
               <StyledTitle active={'carbono' === activeName } >{'<'} 0.3</StyledTitle>
               <StyledTitle active={'acucares' === activeName} >{"<"} 0.3</StyledTitle>
               <StyledTitle active={'protein' === activeName}>23.5</StyledTitle>
               <StyledTitle active={'sal' === activeName}>1.4</StyledTitle>
               <StyledTitle active={'calci' === activeName}>730 ( 91% VRN)</StyledTitle>
            ...
            <StyledInfoBox bg={'green'} center>
              <StyledDivRow abs>
               ...
               <StyledTitle active={'lipidos' === activeName}>5.2</StyledTitle>
               <StyledTitle active={'saturados' === activeName}>3.5</StyledTitle>
               <StyledTitle active={'carbono' === activeName } >{'<'} 0.3</StyledTitle>
               <StyledTitle active={'acucares' === activeName} >{'<'} 0.3</StyledTitle>
               <StyledTitle active={'protein' === activeName}>4.7</StyledTitle>
               <StyledTitle active={'sal' === activeName}>{'<'} 0.28</StyledTitle>
               <StyledTitle active={'calci' === activeName}>146 ( 18% VRN)</StyledTitle>
            </StyledInfoBox>
        ...
        {product.name === 'snack'
          ...
          :
            <IngredientsText pt><StyledBoldText>Ingredientes: </StyledBoldText>{" "} Leite de vaca pasteurizado, fermentos lácteos, coalho e sal.</IngredientsText>   
