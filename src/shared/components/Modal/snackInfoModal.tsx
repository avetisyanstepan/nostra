...
export const SnackModalInfo:React.FC<any> = ({product, close}) => {
        ...
        <StyledBox>
          ...
          <StyledGridContainer>
            <StyledInfoBox mr={'40'} border flex>
              ...
              <StyledTitle 
                active={'fibras' === activeName}
                onClick={() => setActiveName('fibras')}
              >
                {activeName === 'fibras' && <StyledUnionbox> <UnionIcon /></StyledUnionbox>  }
                Fibras (g)
              </StyledTitle>
              <StyledTitle 
            ...
            <StyledInfoBox bg={'green'} mr={'14'} ml center>
              <StyledDivRow abs>
               ...
               <StyledTitle active={'lipidos' === activeName}>12.5</StyledTitle>
               <StyledTitle active={'saturados' === activeName}>10</StyledTitle>
               <StyledTitle active={'carbono' === activeName } >9</StyledTitle>
               <StyledTitle active={'fibras' === activeName} >2.8</StyledTitle>
               <StyledTitle active={'acucares' === activeName} >19.5</StyledTitle>
               <StyledTitle active={'protein' === activeName}>0.8</StyledTitle>
               <StyledTitle active={'sal' === activeName}>530 ( 66% VRN)</StyledTitle>
            </StyledInfoBox>
            <StyledInfoBox bg={'green'} center>
              <StyledDivRow abs>
               ...
               <StyledTitle active={'lipidos' === activeName}>5</StyledTitle>
               <StyledTitle active={'saturados' === activeName}>4</StyledTitle>
               <StyledTitle active={'carbono' === activeName } >3.6</StyledTitle>
               <StyledTitle active={'fibras' === activeName} >1.1</StyledTitle>
               <StyledTitle active={'acucares' === activeName} >7.8</StyledTitle>
               <StyledTitle active={'protein' === activeName}>0.32</StyledTitle>
               <StyledTitle active={'sal' === activeName}>212 ( 27% VRN)</StyledTitle>
            </StyledInfoBox>
