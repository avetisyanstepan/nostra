...
export const productsData = [
    {
        name: 'Leite de Pastagem',
        imgUrl: "./images/Pastagem.png",
        linkto: 'leite'

    },
    {
        name: 'Queijo de Pastagem',
        imgUrl: "./images/carusel1.png",
        linkto: 'queijo'
...
export const productInfoData = [
    {
        name: "leite",
        paragraph: "Leite de Pastagem",
        textInfo: "O Leite de Pastagem Terra Nostra é um leite sem igual. Um leite de vacas felizes que vivem ao ar livre e comem erva fresca todo o ano. Exclusivo de produtores certificados no Programa Leite de Vacas Felizes.  Um leite que faz bem e faz o bem.",
        describeText: 'Descubra o Programa Leite de Vacas Felizes',
        imgProd: "/images/milk.png",
        ...
        product: [
            ...
            {
                name: "Biológico",
                imgUrl: '/images/Biológico.png'
            }
        ],
        productBuyImgUrl: '/images/Inteiro.png',
        nutrionFacts: [
            {
        ...
        nutrionFactsP: 'Leite de Pastagem Inteiro',
        nutrionFactsT: 'O nosso Leite de Pastagem Inteiro é um leite por inteiro porque, a natureza sabe melhor. Não retiramos a nata, retendo as vitaminas e os ácidos gordos de alto valor nutricional. ',
        nutrionImgUrl: '/images/nutrionImg.png',
        modalBackImg: '/images/glassModal.png',
        modalMobileImg: '/images/mobCup.png',
        ...
        hidrat: ['Hidratos de Carbono   (g)', '5', '12,5'],
        dosHidrat: ['dos quais açúcares   (g)', '4.7', '11.8'],
        protein: ['Proteína   (g)', '3.2', '8'],
        sal: ['Sal', '0.1', '0.25'],     
        ribo: ['Riboflavina   (mg)', '0,13 ( 9% VRN)', '0,33 ( 24% VRN)'],
        calci: ['Cálcio   (mg)', '115 ( 14% VRN )', '288 ( 36% VRN )'],
        fosfor: ['Fósforo   (mg)', '91 ( 13% VRN )', '228 ( 33% VRN )'],
        ludo: ['Iodo   (μg)', '21 ( 14% VRN )', '53 ( 25% VRN )']
    },

    {
        name: "queijo",
        paragraph: "Queijo de Pastagem",
        textInfo: "No meio do Atlântico há uma ilha muito especial. É aqui que nasce o nosso Queijo de Pastagem, através das melhores práticas de sustentabilidade e de bem-estar animal. A pensar em todos nós, no planeta e nas próximas gerações. ",
        describeText: 'Descubra o Programa Leite de Vacas Felizes',
...

    {
        name: "snack",
        paragraph: "Snack",
        textInfo: "Uma saborosa combinação de queijo, Terra Nostra e frutos secos. Um snack  sem igual, rico em boa energia, disponível numa embalagem muito prática de transportar e de utilizar em qualquer local. ",
        describeText: 'Descubra o Programa Leite de Vacas Felizes',
        imgProd: "/images/snack.png",
        productName: ['Fatias Light"', 'Fatias Curado', 'Fatias Proteína', 'Bola'],
        product: [
            {
                name: "Snack Queijo, Nozes e Uvas Passas",
                imgUrl: '/images/snackProd.png'
            },
        ...
        nutrionImgUrl: '/images/nutrionImg.png',
        modalBackImg: '/images/Snack3.png',
...

    {
        ...
        nutrionFactsP: 'Manteiga com Sal',
        nutrionFactsT: 'A nossa manteiga com sal é feita com natas de leite de vacas felizes e sal. Nada mais.',
        nutrionImgUrl: '/images/nutrionImg.png',
...

    {
        ...
        product: [
            {
                name: "Leite de Pastagem Biológico",
                imgUrl: '/images/bioMob.png'
            },
            {
                name: "Fatias de Queijo de Pastagem Biológico",
                imgUrl: '/images/bio3.png'
            },
       
        ],
        productBuyImgUrl: '/images/bio4.png',
        nutrionFacts: [
            {
                imgUrl: '/images/nutrion.png',
                desc: 'Cartão certificado pela FSC (Forest Stewardship Council) que garante que é proveniente de florestas geridas de forma responsável de modo a preservar a diversidade biológica e assegurar a sua renovação.'
        ...
        nutrionFactsP: 'Leite de Pastagem Biológico',
        nutrionFactsT: 'O nosso Leite de Pastagem Biológico é um leite de vacas felizes que comem erva fresca 365 dias por ano de pastagens biológicas.',
        nutrionImgUrl: '/images/nutrionImg.png',
        modalBackImg: '/images/glassModal.png',
        modalNutrionFactsImg: '/images/nurtionFacts1Modal.png',
